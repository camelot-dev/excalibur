...
- Excalibur uses [Camelot](https://camelot-py.readthedocs.io/) under the hood, which can detect and extract tables better than other open-source libraries and tools. You can check out a [comparison with other libraries and tools here](https://github.com/socialcopsdev/camelot/wiki/Comparison-with-other-PDF-Table-Extraction-libraries-and-tools).
